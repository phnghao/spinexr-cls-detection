...
## Training
Both of two models after training will be saved their in ```./ouputs/```. In this project, we use two models: DenseNet-210 and Sparse R-CNN. For the former training task, run the script
```bash
cls_train_net.bat
```
